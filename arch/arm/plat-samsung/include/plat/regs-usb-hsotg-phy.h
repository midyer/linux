...
#define S5P_PHYPWR_ANALOG_POWERDOWN_1		(1 << 7)
#define S5P_PHYPWR_FORCE_SUSPEND_1		(1 << 6)
#define S3C_PHYPWR_OTG_DISABLE			(1 << 4)
#define S3C_PHYPWR_ANALOG_POWERDOWN		(1 << 3)
#define SRC_PHYPWR_FORCE_SUSPEND		(1 << 1)
#define S5P_PHYPWR_FORCE_SUSPEND_0		(1 << 0)

#define S5P_PHYPWR_NORMAL_MASK_0		(S5P_PHYPWR_FORCE_SUSPEND_0  | \
						S3C_PHYPWR_ANALOG_POWERDOWN  | \
						S3C_PHYPWR_OTG_DISABLE)

#define S5P_PHYPWR_NORMAL_MASK_1		(S5P_PHYPWR_FORCE_SUSPEND_1  | \
						S5P_PHYPWR_ANALOG_POWERDOWN_1)

#define S3C_PHYCLK				S3C_HSOTG_PHYREG(0x04)
#define S5P_PHYCLK_CLK_FORCE_1			(1 << 7)
...
#define S5P_RSTCON_HOST_SW			(1 << 4)
#define S5P_RSTCON_PHY_1			(1 << 3)
#define S3C_RSTCON_PHYCLK			(1 << 2)
#define S3C_RSTCON_HCLK				(1 << 1)
#define S3C_RSTCON_PHY				(1 << 0)

#define S5P_RSTCON_MSK_0			(S3C_RSTCON_PHY  | \
						S3C_RSTCON_HCLK  | \
						S3C_RSTCON_PHYCLK) \

#define S5P_RSTCON_MSK_1			(S5P_RSTCON_HOST_SW | \
						S5P_RSTCON_PHY_1)
